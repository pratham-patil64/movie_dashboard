...
import { Play, Star, X, Users } from "lucide-react"; // Import Users icon
...
interface MovieDetailsModalProps {
  ...
  onClose: () => void;
  movie: Movie;
  ownerUserId?: string | null; // Added ownerUserId to MovieDetailsModalProps
}

export function MovieDetailsModal({ isOpen, onClose, movie, ownerUserId }: MovieDetailsModalProps) {
  const [isWatchTogetherModalOpen, setIsWatchTogetherModalOpen] = React.useState(false); // State for Watch Together modal
          ...
          <ScrollArea className="max-h-[90vh]">
            ...
            <div className="p-4 sm:p-6 lg:p-8 bg-card text-card-foreground">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                {ownerUserId && ( // Only show if an ownerUserId is provided
                  <Button
                    variant="secondary"
                  ...
                  >
                    <Users className="w-4 h-4 mr-2" /> Watch Together
                  </Button>
                )}
                <Button
                  variant="outline"
