	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'glow-red': 'radial-gradient(circle, hsl(var(--glow-red)) 0%, transparent 70%)'
			},
			boxShadow: {
				'glow': '0 0 20px hsl(var(--glow-red))',
				'card-hover': '0 8px 30px hsl(220 13% 4% / 0.4)',
				'netflix': '0 4px 20px hsl(0 100% 50% / 0.3)'
			},
			borderRadius: {
				lg: 'var(--radius)',
